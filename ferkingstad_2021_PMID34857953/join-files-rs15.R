...
list_data <- lapply(seq_along(list_files), function(i) {
  data <- fread(list_files[[i]], sep = " ", header = FALSE, colClasses = "character")[grepl("^rs15", V1)]
...
# save ====
print("save")
write.table(merged_data, paste0(DIRECTORY, "data_cis-SNPs/data_cis-SNPs-rs15.txt"),
